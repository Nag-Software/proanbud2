...
function StepperIndicator({
  ...
  return (
    <div
      ...
      data-state={state}
      className={cn(
        "border-background bg-muted outline outline-black/15 text-accent-foreground data-[state=completed]:bg-green-500 data-[state=completed]:text-primary-foreground data-[state=active]:bg-primary/90 data-[state=active]:text-primary-foreground relative flex size-6 shrink-0 items-center justify-center overflow-hidden",
