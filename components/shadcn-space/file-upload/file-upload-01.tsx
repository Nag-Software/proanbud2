      ...
      >
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="relative z-20 font-normal text-muted-foreground text-base mt-2">
            Dra og slipp filene dine her eller klikk for å velge filer fra din datamaskin.
          </p>
...
const FileUploadMotion = () => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto min-h-50 border border-dashed bg-background border-muted rounded-xl flex items-center justify-center p-0">
