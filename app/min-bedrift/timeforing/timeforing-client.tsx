    ...
    <Tabs defaultValue="samlet" className="w-full">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-sm text-muted-foreground">
              {canViewAll ? "Alle ansattes registrerte timer" : "Dine registrerte timer"}
            </p>
          </CardContent>
        </Card>
      ...
      <TabsContent value="prosjekt" className="space-y-4">
        ...
        <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
          {byProject.length === 0 ? (
            <p className="text-sm text-muted-foreground">Ingen prosjekttimer ennå.</p>
          ) : (
                ...
                {byEmployee.length === 0 ? (
                  <tr>
                    <td colSpan={4} className="px-4 py-8 text-center text-muted-foreground">
                      Ingen arbeidstimer registrert ennå.
                    </td>
                  </tr>
                ) : (
